...
void drawCircle(GLfloat x, GLfloat y, GLfloat z, GLfloat radius, GLfloat numberOfSides);
...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Exercicio 5", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        drawCircle(0.0f, 0.0f, 0.0f, 0.8f, 30);
